...
int main()
{
    ...
    testSum();
    */
    int array1[6] = {1, 2, 3, 4, 2, 0};
    int array[5] = {6, 7, 8, 9, 10};
    DoublyLinkedList* list;
    DoublyLinkedList* list1;
    //list = convertArrayToDoublyLinkedList(array, 5);
    list1 = convertArrayToDoublyLinkedList(array1, 6);



    printlnListForward(list1);
    printf("%d", checkSumofFirstHalfEqualSumOfSecondHalf(list1));
    //printf("%d", isPalindrome(list1));
    //concatenate(list1,list);
    //printlnListForward(list1);
    //printlnListBackward(list);
    /*DoublyLinkedList* l1;
    l1 = copy(list);
